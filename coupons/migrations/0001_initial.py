...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coupons_redemption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon_redemptions', to=orm['auth.User'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='redemptions', to=orm['coupons.Coupon'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('coupons', ['Redemption'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('coupons_redemption')
    ...
    models = {
        ...
        'coupons.redemption': {
            ...
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'redemptions'", 'to': "orm['coupons.Coupon']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coupon_redemptions'", 'to': "orm['auth.User']"})
        }
    }
